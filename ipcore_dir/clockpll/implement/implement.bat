...
xst -ifn xst.scr
copy clockpll_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\clockpll.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clockpll.ucf clockpll_exdes

echo 'Running map'
map -timing -pr b clockpll_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -tm clockpll_exdes -w routed.ncd routed.v
cd ..
